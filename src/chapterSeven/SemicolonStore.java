...
public class SemicolonStore {
    ...
    private final ArrayList<Integer> productNumber = new ArrayList<>();
    private final ArrayList<java.lang.Double> productNumberAmount = new ArrayList<java.lang.Double>();
    private final ArrayList<java.lang.Double> totalProductNumber = new ArrayList<java.lang.Double>();

    private Integer discountInput ;

    private Double amountPaid;

    private final String storeName = "SEMICOLON STORE";

    private final String Branch = "MAIN BRANCH";

    private final String Address = "312, HERBERT MACAULAY WAY, SABO YABA, LAGOS STATE.";

    private final String number = "8144346693";
